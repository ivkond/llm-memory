# RM-0004: Idempotency keys for write operations
...
Add idempotency keys for all write operations, including fact/session memory, imports, ingests, lint batches, and reindex/archive work, to prevent duplicate knowledge after retries.
