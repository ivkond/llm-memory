# RM-0006: Richer raw memory processing statuses
...
Replace or supplement the boolean `consolidated` marker with richer processing statuses such as `new`, `seen`, `consolidated`, `ignored_low_signal`, `requires_review`, and `failed`.
