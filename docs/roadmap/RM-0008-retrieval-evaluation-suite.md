# RM-0008: Retrieval evaluation suite
...
Add a retrieval evaluation suite with golden queries, expected sources, forbidden stale sources, citation coverage checks, and answer-faithfulness checks.
