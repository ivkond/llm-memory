# RM-0011: Citation faithfulness checks
...
Add citation-faithfulness checks so synthesized answers are verified against retrieved citations rather than merely accompanied by citations.
