# RM-0019: Review workflow for proposed memory changes
...
Add a review workflow for proposed consolidation and promotion changes, allowing users to inspect source entries and proposed Markdown changes before accepting, rejecting, or editing them.
