# RM-0013: Improved consolidate and promote pipeline
...
Improve the consolidate/promote pipeline with explicit promotion rules, confidence thresholds, low-signal archival behavior, and review routing for uncertain records.
