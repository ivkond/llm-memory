# RM-0031: Defer complex scope expressions
...
Keep complex scope expressions deferred, including `wiki/a+projects/b`, glob-style inclusion/exclusion, and `*+!log` query syntax.
