---
name: wiki
description: "LLM Wiki guide - explains available MCP tools for wiki operations. Use when user asks about wiki capabilities, wants to query/remember facts, or check wiki status."
allowed-tools:
  - Bash
  - Read
---
